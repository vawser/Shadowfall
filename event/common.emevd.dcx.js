...
$Event(0, Default, function() {
    // [Shadowfall] Player Setup
    InitializeEvent(0, 9960, 0);
...
$Event(9960, Default, function() {
    EndIf(EventFlag(1031390100));
    
    SetEventFlagID(60120, ON); // Crafting Kit
    SetEventFlagID(60130, ON); // Whetstone Knife
    SetEventFlagID(60140, ON); // Tailoring Tools
    SetEventFlagID(60150, ON); // Golden Tailoring Tools
    
    SetEventFlagID(60400, ON); // Memory Stone 1
    SetEventFlagID(60410, ON); // Memory Stone 2
    SetEventFlagID(60420, ON); // Memory Stone 3
    SetEventFlagID(60430, ON); // Memory Stone 4
    SetEventFlagID(60440, ON); // Memory Stone 5
    SetEventFlagID(60450, ON); // Memory Stone 6
    SetEventFlagID(60460, ON); // Memory Stone 7
    SetEventFlagID(60470, ON); // Memory Stone 8
    
    SetEventFlagID(60500, ON); // Talisman Pouch 1
    SetEventFlagID(60510, ON); // Talisman Pouch 2
    SetEventFlagID(60520, ON); // Talisman Pouch 3
    
    SetEventFlagID(62084, ON); // Reveal Map: Abyss
    SetEventFlagID(62083, ON); // Reveal Map: Rauh Ruins
    SetEventFlagID(62082, ON); // Reveal Map: Southern Shore
    SetEventFlagID(62081, ON); // Reveal Map: Scadu Altus
    SetEventFlagID(62080, ON); // Reveal Map: Gravesite Plain
    
    SetEventFlagID(63084, ON); // Acquired Map: Abyss
    SetEventFlagID(63083, ON); // Acquired Map: Rauh Ruins
    SetEventFlagID(63082, ON); // Acquired Map: Southern Shore
    SetEventFlagID(63081, ON); // Acquired Map: Scadu Altus
    SetEventFlagID(63080, ON); // Acquired Map: Gravesite Plain
    
    SetEventFlagID(65600, ON); // Unlock Affinity 0: Standard
    SetEventFlagID(65610, ON); // Unlock Affinity 1: Heavy
    SetEventFlagID(65620, ON); // Unlock Affinity 2: Keen
    SetEventFlagID(65630, ON); // Unlock Affinity 3: Quality
    SetEventFlagID(65640, ON); // Unlock Affinity 4: Fire
    SetEventFlagID(65650, ON); // Unlock Affinity 5: Flame Art
    SetEventFlagID(65660, ON); // Unlock Affinity 6: Lightning
    SetEventFlagID(65670, ON); // Unlock Affinity 7: Sacred
    SetEventFlagID(65680, ON); // Unlock Affinity 8: Magic
    SetEventFlagID(65690, ON); // Unlock Affinity 9: Occult
    SetEventFlagID(65700, ON); // Unlock Affinity 10: Frost
    SetEventFlagID(65710, ON); // Unlock Affinity 11: Poison
    SetEventFlagID(65720, ON); // Unlock Affinity 12: Blood
    
    SetEventFlagID(1031390100, ON);
});
